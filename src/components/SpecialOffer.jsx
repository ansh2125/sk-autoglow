                            ...
                            <div className="flex flex-col md:flex-row items-center gap-8">
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
                                        Get <span className="text-gradient">Free Bike Cleaning</span> in Your Society!
                                    </h2>

                                    {/* Description */}
                                    <p className="text-white/60 text-lg mb-6">
                                        We’re offering FREE bike cleaning for the first 100 customers in each society.
                                        Experience premium doorstep service with SK AutoGlow — limited slots available!
                                    </p>
