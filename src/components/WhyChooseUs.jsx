            ...
            <div className="relative z-10 container mx-auto px-4 lg:px-8">
                ...
                >
                    ...
                    <p className="text-white/60 text-lg max-w-3xl mx-auto leading-relaxed">
                        And to show our confidence, we offer a special deal: try our service for one month, and if you don’t love it, you pay nothing.
                        That’s our promise—pure, flawless care with zero risk.
                        <br />
                        <span className="text-gold font-semibold">जिसका काम, उसी को साजे।</span>
                    </p>
                </motion.div>
